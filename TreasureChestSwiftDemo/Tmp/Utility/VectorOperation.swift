...
//投影值：向量*cosine
public func vectorProjection(vector: CGPoint, cosine:CGFloat) -> CGFloat {
...
//弧度转角度
public func radianToAngle(radian: CGFloat) -> CGFloat {
...
public func vector(startPoint: CGPoint, endPoint: CGPoint) -> CGPoint {
...
//两个向量的夹角度数：0~360
public func vectorsAngle(vectorA: CGPoint, vectorB: CGPoint) -> CGFloat {
...
//两个向量的夹角的cos值
public func vectorsCosine(vectorA: CGPoint, vectorB: CGPoint) -> CGFloat {
...
//向量的模
public func vectorModulus(point: CGPoint) -> CGFloat {
...
*/
public func isVectorRight(vectorA: CGPoint, vectorBenchmark: CGPoint) -> Bool {
