...
func dateFromTimestamp(seconds:Int) -> String {
    let formatter = DateFormatter()
...
func dateFromTimestamp(seconds:Int, format: String) -> String {
    let formatter = DateFormatter()
...
//////////////////////////////////////
func dateStringToDate(dateString: String) -> String {
    let formatter = DateFormatter()
    formatter.dateFormat = "yyyy.MM.dd"
    formatter.locale = Locale.current
...
func dateFromUTCdateString(dateString: String) -> Date? {
    let formatter = DateFormatter()
...
func isOneDayEndedCompareWithToday(oneDayString: String) -> Bool{
    let today = Date()
