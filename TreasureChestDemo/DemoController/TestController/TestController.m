...
- (void)buttonEvent:(UIButton *)button {
    NSString *path = @"/Users/jf/Desktop/Project/TreasureChest/TreasureChestDemo/TreasureChestDemo/Resources/\ 1.bytes";
//    NSString *path = [[NSBundle mainBundle]pathForResource:@"1" ofType:@"bytes"];
//    NSString *path = [[NSBundle mainBundle]pathForResource:@"words_finance" ofType:@"txt"];
